 ...
 */
void HeuristicGeoTestBase::run(TrackSlotId::size_type num_states,
                               size_type num_steps,
                               real_type tolerance)
{
 ...
 */
template<MemSpace M>
auto HeuristicGeoTestBase::run_impl(TrackSlotId::size_type num_states,
...
auto HeuristicGeoTestBase::get_avg_path_impl(
    VecReal const& path, TrackSlotId::size_type num_states) const -> VecReal
{
