...
#    define CELER_ASSERT_UNREACHABLE() CELER_DEBUG_ASSERT_(false, unreachable)
#else
...
#ifndef __CUDA_ARCH__
#    define CELER_INSIST(COND, MSG) CELER_RUNTIME_ASSERT_(COND, MSG)
#else
#    define CELER_INSIST(COND, MSG)                                            \
        ::celeritas::throw_debug_error(::celeritas::DebugErrorType::assertion, \
                                       "CELER_INSIST cannot be called from "   \
                                       "device code",                          \
                                       __FILE__,                               \
                                       __LINE__)
#endif
