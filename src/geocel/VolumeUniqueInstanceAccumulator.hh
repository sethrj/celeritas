...
//---------------------------------------------------------------------------//
//! \file geocel/VolumeUniqueInstanceAccumulator.hh
//---------------------------------------------------------------------------//
#pragma once
 ...
 *
 * \code
   VolumeUniqueInstanceAccumulator acc{params.host_ref()};
 ...
 * \endcode
 */
class VolumeUniqueInstanceAccumulator
{
  public:
    //!@{
    //! \name Type aliases
  ...
  public:
    ...
    VolumeUniqueInstanceAccumulator(ParamsRef const& params)
        : params_(params)
    {
    }
 ...
 */
CELER_FUNCTION VolumeUniqueInstanceId
VolumeUniqueInstanceAccumulator::operator()(VolumeUniqueInstanceId uid,
