 ...
 * secondaries produced). The first secondary may be saved to the `secondary`
 * field; additional secondaries must be allocated and saved to
 * `secondaries`.
 */
struct Interaction
{
...
{
    return (this->secondary ? 1 : 0) + this->secondaries.size();
}
