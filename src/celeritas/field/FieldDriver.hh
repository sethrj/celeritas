 ...
 * momentum update.
 *
 * The chord update iteratively reduces the given step length until the sagitta
 * is no more than \c delta_chord . The sagitta is calculated as the projection
 * of the mid-step point onto the line between the start and end-step points.
 *
